(function() {
    ...
    MetricsController.$inject = ['$scope','$http','$uibModal'];

    function MetricsController ($scope,$http,$uibModal) {
        ...
        $scope.showNUmber = function(){
            ...
            var url = "/getMetricsByNumber/" + $scope.searchNumber;
            $http.get(url) 
                .success(function(data) { 
                    $scope.metrics = data
                    showAlert("Caricato!")
